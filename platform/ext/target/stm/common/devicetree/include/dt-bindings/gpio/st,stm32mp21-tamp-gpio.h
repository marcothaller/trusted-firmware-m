 ...
 */
#ifndef _DT_BINDINGS_STM32MP21_TAMP_GPIO_H
#define _DT_BINDINGS_STM32MP21_TAMP_GPIO_H

#define _TAMP_IN1RMP_PC4		_TAMP_MUX(0, 0)
#define _TAMP_IN1RMP_PI8		_TAMP_MUX(1, 0)
#define _TAMP_IN2RMP_PF7		_TAMP_NOMUX
#define _TAMP_IN3RMP_PC3		_TAMP_NOMUX
#define _TAMP_IN4RMP_PG1		_TAMP_NOMUX
#define _TAMP_IN5RMP_PF6		_TAMP_NOMUX
...
#define _TAMP_INRMP_MASK		GENMASK_32(0, 0)
...
#endif /* _DT_BINDINGS_STM32MP21_TAMP_GPIO_H */
