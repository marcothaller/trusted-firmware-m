 ...
 *
 * fork from zephyr: iterable_sections.h
 */

#ifndef INCLUDE_ITERABLE_SECTIONS_H_
#define INCLUDE_ITERABLE_SECTIONS_H_
 ...
 *
 * @details
 * Convenience helper combining __in_section() and DECL_ALIGN().
 * The section name will be '.[SECNAME].static.[SECTION_POSTFIX]_'
 *
...
#endif /* INCLUDE_ITERABLE_SECTIONS_H_ */
